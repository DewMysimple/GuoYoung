...
| [[Wiki/决策/ADR-004\|ADR-004]] | 图标采用七级自动回退链与 64px 高清门槛（由 ADR-014 取代） | superseded | 功能添加·第008次、Bug处理·第004次、工程讨论·第001次 |
...
| [[Wiki/决策/ADR-009\|ADR-009]] | 高级微调只开放几何参数，颜色统一由主题色管理（由 ADR-015 取代） | superseded | [[Wiki/日志/功能添加/第012次\|功能添加·第012次]] |
...
| [[Wiki/决策/ADR-014\|ADR-014]] | 图标契约按平台候选顺序和实际缓存语义维护 | accepted | [[Wiki/日志/功能添加/第036次\|功能添加·第036次]] |
| [[Wiki/决策/ADR-015\|ADR-015]] | 外观以方案选择和四项布局微调取代五分类参数面板 | accepted | [[Wiki/日志/功能添加/第037次\|功能添加·第037次]] |
