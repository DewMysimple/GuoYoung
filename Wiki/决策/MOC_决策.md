...
| [[Wiki/决策/ADR-015\|ADR-015]] | 外观以方案选择和四项布局微调取代五分类参数面板（由 ADR-016 取代） | superseded | [[Wiki/日志/功能添加/第037次\|功能添加·第037次]] |

| [[Wiki/决策/ADR-016\|ADR-016]] | 外观保留简洁方案并增加尺寸与恢复入口 | accepted | [[Wiki/日志/功能添加/第038次\|功能添加·第038次]] |
